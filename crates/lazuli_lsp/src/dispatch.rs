...
use crate::{
    ...
    emits_derived_diagnostics, env_schema_diagnostics, env_top_level_legacy_diagnostics,
    error_contract_diagnostics, escape_route_security_diagnostics,
    event_consumer_payload_diagnostics, event_job_tenant_from_diagnostics, event_kind_diagnostics,
    event_locator_diagnostics, event_payload_reference_diagnostics,
    event_trace_trigger_diagnostics, extension_declaration_diagnostics,
    extension_reference_diagnostics, external_call_contract_diagnostics,
    external_contract_diagnostics, feature_requirements_contract_diagnostics,
    feature_unknown_kind_diagnostics, field_security_policy_diagnostics,
    file_capability_contract_diagnostics, first_line_range, generated_summary_diagnostics,
    has_many_diagnostics, headers_contract_diagnostics, idempotency_key_diagnostics,
    is_canonical_source, is_lzx_source, lookup_shorthand_diagnostics, lzx_contract_diagnostics,
    lzx_route_contract_diagnostics, namespace_reference_diagnostics, non_goals_shape_diagnostics,
    notification_contract_diagnostics, policy_namespace_diagnostics, previously_mode_diagnostics,
    profile_contract_diagnostics, query_filter_index_diagnostics, query_mode_diagnostics,
    query_order_default_diagnostics, query_pagination_diagnostics, query_search_syntax_diagnostics,
    query_statement_unknown_diagnostics, range_from_span, refs_block_diagnostics,
    registry_contract_diagnostics, registry_unknown_kind_diagnostics,
