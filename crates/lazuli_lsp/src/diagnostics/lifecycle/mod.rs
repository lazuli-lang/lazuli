...
pub(crate) use completion::{
    ...
    lifecycle_resume_completion_items, lifecycle_scoped_label,
    lifecycle_state_completion_items, lifecycle_view_completion_items,
    lifecycle_view_slot_trigger, requires_lifecycle_state_trigger, resume_arm_start_trigger,
    resume_arm_view_keyword_trigger, resume_arm_view_target_trigger, resume_header_source_trigger,
};
#[allow(unused_imports)]
pub(crate) use gate::{
    lifecycle_default_gate_state, lifecycle_feature_is_reachable,
    lifecycle_gate_candidate_for_view, lifecycle_gate_insertion_line,
    lifecycle_pending_resume_for_view, lifecycle_reachable_features,
    lifecycle_resource_for_name, lifecycle_resource_for_source_ref,
    lifecycle_resource_for_submit_ref, lifecycle_resources_hosted_by_view,
    lifecycle_state_from_view_path, lifecycle_view_path, view_has_requires_lifecycle,
    LifecycleGateCandidate,
};
#[allow(unused_imports)]
pub(crate) use hover::{
...
pub(crate) use lookup::{
    collect_lifecycle_lookup_queries, resolve_lifecycle_command_resource,
    resolve_lifecycle_lookup_query, LifecycleLookupQueryInfo,
};
#[allow(unused_imports)]
pub(crate) use parse::{
...
pub(crate) use resume::{
    ...
    lifecycle_missing_resume_states, lifecycle_parse_resume_arm,
    ...
    LifecycleResumeArm, LifecycleResumeBlock,
};
#[allow(unused_imports)]
pub(crate) use state::{
    collect_lifecycle_resources, lifecycle_state_children, lifecycle_states_in_resource_block,
    LifecycleResourceInfo,
};
