...
impl LanguageServer for Backend {
    ...
    async fn completion(&self, params: CompletionParams) -> Result<Option<CompletionResponse>> {
        ...
        // closed-catalog argument values. The cursor's prefix on the
        // current line is matched against four closed catalogs;
        // outside `@cap.File(...)` the response falls back to the
        // keyword list.
