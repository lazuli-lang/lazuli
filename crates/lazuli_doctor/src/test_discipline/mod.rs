...
pub mod test_eval_verb_retired_001;
pub mod test_failure_only_coverage_001;
pub mod test_fixture_literal_001;
pub mod test_handler_missing_001;
pub mod test_matrix_verb_misplaced_001;
pub mod test_missing_authored_001;
pub mod test_pins_stub_vocab_001;
...
pub mod test_view_extension_verb_retired_001;
