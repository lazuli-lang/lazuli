...
pub mod creates_empty_bindings_001;
pub mod ctx_path_unresolved_001;
...
pub mod migration_alter_missing_001;
pub mod migration_idempotent_create_001;
pub mod missing_policy_on_query_001;
pub mod mutation_without_readback;
pub mod plugin_contract_001;
pub mod policy_category_shadows_effect_001;
pub mod policy_ref_unresolved_001;
...
pub mod runtime_emitted_table_migration_001;
pub mod runtime_reachable_stub_001;
pub mod runtime_wiring_absolute_path_001;
