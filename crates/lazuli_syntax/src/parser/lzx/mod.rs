...
//! - End-to-end `parse_lzx_document` tests live in the sibling file
//!   `lzx_parser_tests.rs` (kept verbatim so raw-string fixtures
//!   preserve their canonical indentation).
//!
...
#[cfg(test)]
#[path = "lzx_parser_tests.rs"]
mod lzx_parser_tests;
