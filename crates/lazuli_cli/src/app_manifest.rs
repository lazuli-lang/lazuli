use lazuli_ir::{
    ...
    ContractRecord, FeatureRequirement, QualifiedName, RegistryToolEntry, ToolEffect, WebhookEvent,
    WebhookEventField, WorkspaceApp, WorkspaceBoundary, WorkspaceCommunication, WorkspaceGateway,
