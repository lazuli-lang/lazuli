...
use super::{
    ...
    command_output_ts_type, command_sdk_slots, escape_js_string, format_audit_ts,
    format_policy_ts, format_string_array, legacy_query_ident, pick_query_resource_ts, query_args,
    query_ident, resource_field_ts_name, resource_field_ts_type, ts_type_for_type_ref,
