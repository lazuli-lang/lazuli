...
pub use nodes::ai_primitives::{
    Agent, AgentOutputKind, Api, DiscriminatorRef, EvalAssertion, EvalAssertionKind,
    EvalContainsRhs, EvalCase, EvalPredicate, GoldenSpec, HttpExposure, HttpMethod,
    QualifiedToolRef, ToolBinding, ToolEffect, ToolKind, ToolsCallsOp,
};
...
pub use nodes::event::{
    ...
    Rule, TraceFiresPer, built_in_trace_event, built_in_trace_event_records,
    built_in_trace_events, is_reserved_trace_event_name,
};
