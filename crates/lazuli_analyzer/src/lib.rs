...
use helpers::{
    conventions_levenshtein, find_keyword_line_offset, find_top_level_operator,
    first_paren_balanced_token, has_top_level_comma, is_valid_design_hex, levenshtein,
...
mod tests {
    ...
    use super::{
        ...
        parse_query_filter_line, resolve_invalidates_targets, type_ref_from_syntax,
    };
