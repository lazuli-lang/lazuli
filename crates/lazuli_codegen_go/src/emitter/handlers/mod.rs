...
use paths::{
    escape_comment, escape_string, exported_func_name, handler_path, handlers_package_name,
    path_exists, path_name_for,
};
use types::{go_type_for_stub, qualify_generated_stub_type};
...
mod tests {
    use super::*;
    use lazuli_ir::{
        Auth, AuthIdentity, AuthPassword, BuiltinType, CapabilityRef, CommandKind, Defaults,
        Extension, FieldConstraints, FieldRef, HashAlgorithm, HashedCapability, Path, PathRef,
        PathSource, Policies, QualifiedName, TypedSlot,
    };
