...
mod tests {
    ...
    fn canonical_file_api_emits_real_type_storage_and_register_placeholder() {
        ...
        api.rate_limit = Some(RateLimitSpec::from_default("10 per hour per user"));
    ...
    fn path_params_emit_inferred_args_and_method_constant() {
        ...
        api.rate_limit = Some(RateLimitSpec::from_default("60 per minute per user"));
        feature.apis.push(api);
    ...
    fn feature_with_api() -> Feature {
        Feature {
            ...
            apis: vec![Api {
                ...
                policy_expr: None,
                policy_when_denied: None,
                rate_limit: Some(RateLimitSpec::from_default("30 per minute per user")),
