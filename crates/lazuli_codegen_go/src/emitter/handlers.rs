...
/// (`app/features/<feature>/<name>.go`) — the orchestrator detects the
/// `app/features/` prefix and writes to project root, not to the codegen
/// `out_dir`. This is the Tier 1 portable home defined in
/// `docs/project-structure.md`.
///
/// `module_name` is the user's Go module path (e.g.
/// `github.com/myorg/myapp` or `lazuli/myapp`) — used to construct the
/// import alias `<module_name>/dist/go/<feature>` so user handlers can
/// reference generated types via `<feature>gen.<TypeName>`.
///
