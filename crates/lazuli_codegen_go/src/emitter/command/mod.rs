...
use policy::{format_policy_with_expr, walk_policy_expr_atoms};
...
struct SemanticValidatorPlugin {
    alias: String,
    import_path: String,
}
...
fn emit_semantic_validate_prelude(p: &mut GoPrinter, command: &Command, output_type: &str) {
