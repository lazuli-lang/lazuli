...
use lazuli_ir::{
    BuiltinType, Expr, Feature, KeyClause, ListQuery, LookupQuery, Query, Resource, TypeRef,
    TypedSlot,
};
...
mod util;
use util::{
    lower_camel, pascal_case, plural_pascal, query_kind_rank, write_section_banner,
};
...
mod filters;
use filters::{emit_filters, emit_lookup_by_with_filters, emit_order};
...
mod tests {
    use super::*;
    use lazuli_ir::{
        AppManifest, CacheTtl, CacheTtlLiteral, CompareOp, Defaults, Field, Filter, Gate, Module,
        OrderDir, Policies, PolicyRef, Predicate, QualifiedName, QueryCache, Record, SqlQuery,
        Tenancy,
    };
