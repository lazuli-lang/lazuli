...
// VerifyPassword is the user-authored implementation of `@fn.verify_password`.
//   Site: auth.auth.password.verify
// IMPLEMENT ME
//
...
// through lazuli.ReturnsFromRegistry[I, O]("auth.verify_password"),
...
func VerifyPassword(ctx *lazuli.Ctx, input any) (any, error) {
	if ctx.Context == nil {
	...
	var zero any
	return zero, errors.New("verify_password not yet implemented")
}

//lazuli:pattern extension_stub v1
func init() {
	lazuli.RegisterFn("auth.verify_password", VerifyPassword)
}
