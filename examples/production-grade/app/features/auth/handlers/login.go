...
import (
	...
	authgen "github.com/lazuli-lang/example-production-grade/generated/auth"
...
// through lazuli.ReturnsFromRegistry[I, O]("auth.login"),
...
func Login(ctx *lazuli.Ctx, input authgen.LoginResultInput) (string, error) {
	if ctx.Context == nil {
...
//lazuli:pattern extension_stub v1
func init() {
	lazuli.RegisterFn("auth.login", Login)
}
