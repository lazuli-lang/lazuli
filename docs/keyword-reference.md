...
| `command` | `keyword.control.declaration.structural.lazuli` | `keyword` | — | Declares a write command (mutation effect). | `CODEGEN-UNRESOLVED-BINDING-SOURCE-001`<br>`COMMAND-INPUT-SHADOWS-FIELD-001`<br>`HOOK-TARGET-001`<br>`MUTATION-WITHOUT-READBACK-001` |
