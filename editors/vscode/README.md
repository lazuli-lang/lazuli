...
- Section containers: `defaults`, `constraints`, `policies`, `errors`, `params`, `route`, `key`, `scope`, `filters`, `cells`, `payload`, `non_goals`, `delegated_to`, `out_of_scope`, `targets`, `environments`, `urls`, `env`, `capabilities`, `architecture`, `services`, `communication`, `runtime`, `deploy`.
