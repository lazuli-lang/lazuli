...
- Internal statements: `creates`, `updates`, `deletes`, `input`, `route`, `let`, `target`, `policy`, `emits`, `invalidates`, `trigger`, `idempotency`, `retry`, `handler`, `validate`, `validates`, `deny`, `permits`, `forbids`, `message`, `source`, `submit`, `columns`, `fields`, `sections`, `slot`, `platforms`, `previously`, `migrated`, `alias`, and app/runtime verbs such as `serves`, `runs`, `healthcheck`, `migrations`, and `rollback`.
